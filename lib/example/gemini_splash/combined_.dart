...
class EnhancedStarPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final glowPaint = Paint()
      ..color = primaryColor.withOpacity((glowIntensity * 0.7).clamp(0.0, 1.0))
    ...
    if (explosionProgress > 0) {
      ...
      final screenGlowRect = Rect.fromLTWH(
          -size.width, size.height * 0.5, size.width * 3, size.height);
      ...
      final radius = size.width / 2 * (1 + explosionProgress * 2.5);
